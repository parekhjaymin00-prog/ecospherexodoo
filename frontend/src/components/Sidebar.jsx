...
const navigation = [
  ...
  { name: 'Departments', path: '/departments', icon: 'departments' },
  { name: 'Environmental', path: '/environmental', icon: 'environmental' },
...
export default function Sidebar({ open, onClose }) {
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#111111] border-r border-[#2A2A2A] transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${
        open ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-[#2A2A2A]">
        <span className="text-white text-lg font-bold tracking-tight">EcoSphere</span>
      </div>
